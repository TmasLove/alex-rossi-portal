...
import { AlertCircle, Check, Trash2, ArrowLeft, FileEdit } from "lucide-react";
  ...
  return (
    <div className="min-h-screen pb-24" style={{ backgroundColor: "#F5EFE6" }}>
      ...
      <div className="mx-auto max-w-2xl px-6 py-10">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            ...
            <button
              ...
              disabled={saving}
              className="px-6 py-3 text-[.68rem] font-semibold tracking-[.14em] uppercase transition-colors hover:opacity-85 disabled:opacity-50"
        ...
        <div
          className="mt-6 p-6"
          style={{ border: "1px solid rgba(212,87,58,.25)", backgroundColor: "rgba(212,87,58,.04)" }}
        >
          <p className="mb-3 text-[.62rem] tracking-[.16em] uppercase font-semibold" style={{ color: "#D4573A" }}>
            Zona de peligro
          </p>
          <button
            onClick={handleDelete}
            disabled={deleting}
            className="flex items-center gap-2 px-5 py-2.5 text-[.68rem] font-semibold tracking-[.14em] uppercase transition-colors hover:bg-[#E8795A] disabled:opacity-50"
...
function Field({
  ...
  return (
    <div>
      ...
      {children}
      {error && <p className="mt-1.5 text-xs" style={{ color: "#D4573A" }}>{error}</p>}
    </div>
  );
}
